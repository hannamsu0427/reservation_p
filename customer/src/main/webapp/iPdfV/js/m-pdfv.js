...
function configure(PDFJS) {
	PDFJS.imageResourcesPath = '/iPdfV/images/';
	PDFJS.workerSrc = '/iPdfV/js/pdf.worker.js';
	PDFJS.cMapUrl = '/iPdfV/cmaps/';
 ...
 * @return {Object} The object with horizontal (sx) and vertical (sy) scales. 
 * The scaled property is set to false if scaling is not required, true otherwise.
 */
 ...
 *  @returns {Array} Estimated fraction: the first array item is a numerator, the second one is a denominator.
 */
...
var DEFAULT_PREFERENCES = {
	showPreviousViewOnLoad: false, //true ---> false로 변경하여 초기화 함
	defaultZoomValue: '', // zoom 사이즈는 알아서 맞추기를 그래로 둠
	sidebarViewOnLoad: 0, // 1로하면 사이드바가 처음부터 보임
...
// �떎�슫濡쒕뱶 踰꾪듉�쓣 �늻瑜대㈃ �옉�룞�릺�뒗 function
...
var DownloadManager = (function DownloadManagerClosure() {
	...
	DownloadManager.prototype = {downloadUrl: function DownloadManager_downloadUrl(url, filename) {
...
var ViewHistory = (function ViewHistoryClosure() {
	...
	ViewHistory.prototype = {_writeToStorage: function ViewHistory_writeToStorage() {
		return new Promise(function (resolve) {
...
var HOSTED_VIEWER_ORIGINS = ['null', 'http://stest.itsp.kr:90', 'http://localhost:8080'];
